...
--
-- Host: 127.0.0.1    Database: recadastramento
-- ------------------------------------------------------
...
INSERT INTO `cargos` VALUES (1,'TÃ©cnico em InformÃ¡tica'),(2,'TÃ©cnico em AdministraÃ§Ã£o Escolar'),(3,'TÃ©c. em Manut. de Infraestrutura Escolar'),(4,'Auxiliar de ServiÃ§os Gerais'),(5,'TÃ©cnico'),(6,'Contador'),(7,'Professor');
/*!40000 ALTER TABLE `cargos` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `cedidos`
--

DROP TABLE IF EXISTS `cedidos`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `cedidos` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `Funcional_id` int(11) NOT NULL,
  `setor_origem` varchar(150) NOT NULL,
  `setor_destino` varchar(150) NOT NULL,
  `onus` tinyint(4) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `cedidos`
--

LOCK TABLES `cedidos` WRITE;
/*!40000 ALTER TABLE `cedidos` DISABLE KEYS */;
/*!40000 ALTER TABLE `cedidos` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `cidades` (
  ...
  CONSTRAINT `fk_Cidade_Estado` FOREIGN KEY (`Estado_id`) REFERENCES `estados` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
--
-- Table structure for table `comprovantes_tipocomprovantes`
--

DROP TABLE IF EXISTS `comprovantes_tipocomprovantes`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `comprovantes_tipocomprovantes` (
  `comprovante_id` int(11) NOT NULL,
  `tipocomprovante_id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `comprovantes_tipocomprovantes`
--

LOCK TABLES `comprovantes_tipocomprovantes` WRITE;
/*!40000 ALTER TABLE `comprovantes_tipocomprovantes` DISABLE KEYS */;
/*!40000 ALTER TABLE `comprovantes_tipocomprovantes` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `dados_servidores`
--

DROP TABLE IF EXISTS `dados_servidores`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `dados_servidores` (
  `MATRICULA_FUNCIONAL` varchar(10) NOT NULL,
...
--
-- Dumping data for table `dados_servidores`
--

LOCK TABLES `dados_servidores` WRITE;
/*!40000 ALTER TABLE `dados_servidores` DISABLE KEYS */;
/*!40000 ALTER TABLE `dados_servidores` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `enderecos` (
  ...
  KEY `fk_Endereco_Servidor1_idx` (`Servidor_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `estadocivis`
--
...
--
-- Dumping data for table `estadocivis`
--

LOCK TABLES `estadocivis` WRITE;
/*!40000 ALTER TABLE `estadocivis` DISABLE KEYS */;
INSERT INTO `estadocivis` VALUES (1,'Solteiro'),(2,'Casado'),(3,'Viuvo'),(4,'Separado'),(5,'Divorciado');
/*!40000 ALTER TABLE `estadocivis` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `formacoes` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `Servidor_id` int(11) NOT NULL,
  `Nivelescolaridade_id` int(11) NOT NULL,
  `curso` varchar(45) DEFAULT NULL,
  `instituicao` varchar(45) DEFAULT NULL,
  `conclusao` year(4) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_Formacao_Nivelescolaridade1_idx` (`Nivelescolaridade_id`),
  KEY `fk_Formacao_Funcionario1` (`Servidor_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `funcionais`
--

DROP TABLE IF EXISTS `funcionais`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `funcionais` (
  ...
  `efetivoexercicio` date DEFAULT NULL,
  `registroclasse` varchar(45) DEFAULT NULL,
  `Setor_id` int(11) NOT NULL,
  `Funcao_id` int(11) NOT NULL,
  `Cargo_id` int(11) NOT NULL,
  `Regimejuridico_id` int(11) NOT NULL,
  `licenca` tinyint(4) DEFAULT NULL,
  `cid` varchar(45) DEFAULT NULL,
  `vencimentolicenca` date DEFAULT NULL,
  `reintegrado` tinyint(4) DEFAULT NULL,
  `datareintegracao` date DEFAULT NULL,
  `outro_cargo_publico` varchar(150) NOT NULL,
  `orgao_outro_cargo` varchar(150) NOT NULL,
  `outrafuncao` varchar(150) NOT NULL,
  `setorinput` varchar(150) NOT NULL,
  `cargoinput` varchar(150) NOT NULL,
  `funcaoinput` varchar(150) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_Funcionais_Setor1_idx` (`Setor_id`),
  KEY `fk_Funcionais_Funcao1_idx` (`Funcao_id`),
  KEY `fk_Funcionais_Cargo1_idx` (`Cargo_id`),
  KEY `fk_Funcionais_Regimejuridico1_idx` (`Regimejuridico_id`),
  KEY `fk_Funcionais_Servidor1` (`Servidor_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `funcionais`
--

LOCK TABLES `funcionais` WRITE;
/*!40000 ALTER TABLE `funcionais` DISABLE KEYS */;
/*!40000 ALTER TABLE `funcionais` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `funcoes` VALUES (1,'CoordenaÃ§Ã£o'),(3,'Vigia'),(4,'Zelador / Merendeira'),(5,'Contador'),(6,'SecretÃ¡rio / Aux. de secretaria'),(7,'TÃ©c. em InformÃ¡tica'),(8,'Docencia'),(999,'Outra');
/*!40000 ALTER TABLE `funcoes` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `nivelescolaridades`
--

DROP TABLE IF EXISTS `nivelescolaridades`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `nivelescolaridades` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `nivelescolaridades`
--

LOCK TABLES `nivelescolaridades` WRITE;
/*!40000 ALTER TABLE `nivelescolaridades` DISABLE KEYS */;
INSERT INTO `nivelescolaridades` VALUES (1,'BÃ¡sico'),(2,'MÃ©dio'),(3,'Superior'),(4,'EspecializaÃ§Ã£o'),(5,'Mestrado'),(6,'Doutorado');
/*!40000 ALTER TABLE `nivelescolaridades` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `regimejuridicos`
--

DROP TABLE IF EXISTS `regimejuridicos`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `regimejuridicos` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `descricao` varchar(45) NOT NULL,
  PRIMARY KEY (`id`)
...
--
-- Dumping data for table `regimejuridicos`
--

LOCK TABLES `regimejuridicos` WRITE;
/*!40000 ALTER TABLE `regimejuridicos` DISABLE KEYS */;
INSERT INTO `regimejuridicos` VALUES (1,'EstatutÃ¡rio');
/*!40000 ALTER TABLE `regimejuridicos` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `servidores` (
  ...
  `matricula2` int(11) DEFAULT NULL,
  `nome` varchar(55) NOT NULL,
  `cpf` varchar(14) NOT NULL,
  `pis_pasep` varchar(11) NOT NULL,
  `tiposanguineo` varchar(3) NOT NULL,
  `rg` varchar(45) NOT NULL,
  `rg_org_exp` varchar(45) NOT NULL,
  `rg_data_emi` date NOT NULL,
  `titulo_eleitor` varchar(20) NOT NULL,
  `zona_eleitoral` varchar(5) NOT NULL,
  `secao_eleitoral` varchar(5) NOT NULL,
  `titulo_data_emi` date NOT NULL,
  ...
  `fonetrabalho` varchar(14) DEFAULT NULL,
  ...
  `emailpessoal` varchar(100) DEFAULT NULL,
  `necessidadesespeciais` varchar(40) NOT NULL,
  `cid` varchar(45) DEFAULT NULL,
  `tempoaverbado` tinyint(4) DEFAULT NULL,
  `tempoaaverbar` tinyint(4) DEFAULT NULL,
  `especialidade` varchar(50) DEFAULT NULL,
  `concluido` tinyint(4) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `fk_Servidor_Cidade1_idx` (`Cidade_nasc`),
  KEY `fk_Servidor_Estadocivil1_idx` (`Estadocivil_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `setores` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `setor_vinculo` int(11) DEFAULT NULL,
  `descricao` varchar(200) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_setor_setor1_idx` (`setor_vinculo`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `tipocomprovantes`
--

DROP TABLE IF EXISTS `tipocomprovantes`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tipocomprovantes` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `tipo` varchar(45) NOT NULL,
  PRIMARY KEY (`id`)
...
--
-- Dumping data for table `tipocomprovantes`
--

LOCK TABLES `tipocomprovantes` WRITE;
/*!40000 ALTER TABLE `tipocomprovantes` DISABLE KEYS */;
INSERT INTO `tipocomprovantes` VALUES (1,'Carteira de identidade (RG)'),(2,'CPF'),(3,'TÃ­tulo de eleitor'),(4,'Certificado de reservista'),(5,'CertidÃ£o de nascimento'),(6,'Certificado de nÃ­vel mÃ©dio ou fundamental '),(7,'Certificado de curso de especializaÃ§Ã£o'),(8,'Certificado de curso de mestrado'),(9,'Certificado de curso de doutorado'),(10,'CartÃ£o do PIS/PASEP'),(11,'Carteira de Trabalho'),(12,'CertidÃ£o de casamento'),(13,'DeclaraÃ§Ã£o de uniÃ£o estÃ¡vel'),(14,'Comprovante de residÃªncia'),(15,'Certificado de curso tÃ©cnico'),(16,'Certificado de curso superior'),(17,'Portaria de nomeaÃ§Ã£o');
/*!40000 ALTER TABLE `tipocomprovantes` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `users` VALUES (1,'admin','a659f9d151298abf8013823720be6b9164bfd37d','2013-02-14 15:46:30','2013-02-14 15:46:30');
/*!40000 ALTER TABLE `users` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Temporary view structure for view `vi_cedidos`
--

DROP TABLE IF EXISTS `vi_cedidos`;
/*!50001 DROP VIEW IF EXISTS `vi_cedidos`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `vi_cedidos` AS SELECT 
 1 AS `Quantidade de funcionarios cedidos de uma secretaria para outra`*/;
SET character_set_client = @saved_cs_client;

--
-- Temporary view structure for view `vi_countnivel`
--

DROP TABLE IF EXISTS `vi_countnivel`;
/*!50001 DROP VIEW IF EXISTS `vi_countnivel`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `vi_countnivel` AS SELECT 
 1 AS `descricao`,
 1 AS `quant`*/;
SET character_set_client = @saved_cs_client;

--
-- Temporary view structure for view `vi_dadosrelevantes`
--

DROP TABLE IF EXISTS `vi_dadosrelevantes`;
/*!50001 DROP VIEW IF EXISTS `vi_dadosrelevantes`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `vi_dadosrelevantes` AS SELECT 
 1 AS `nome`,
 1 AS `Cargo`,
 1 AS `Funcao`,
 1 AS `Escolaridade`,
 1 AS `Idade`,
 1 AS `Necessidades especiais`,
 1 AS `Data de Admissão`*/;
SET character_set_client = @saved_cs_client;

--
-- Temporary view structure for view `vi_delicenca`
--

DROP TABLE IF EXISTS `vi_delicenca`;
/*!50001 DROP VIEW IF EXISTS `vi_delicenca`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `vi_delicenca` AS SELECT 
 1 AS `Quantidade de servidores de licenca`*/;
SET character_set_client = @saved_cs_client;

--
-- Temporary view structure for view `vi_estadoscivis`
--

DROP TABLE IF EXISTS `vi_estadoscivis`;
/*!50001 DROP VIEW IF EXISTS `vi_estadoscivis`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `vi_estadoscivis` AS SELECT 
 1 AS `Descricao`,
 1 AS `Quantidade`*/;
SET character_set_client = @saved_cs_client;

--
-- Temporary view structure for view `vi_funcaoxcargahoraria`
--

DROP TABLE IF EXISTS `vi_funcaoxcargahoraria`;
/*!50001 DROP VIEW IF EXISTS `vi_funcaoxcargahoraria`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `vi_funcaoxcargahoraria` AS SELECT 
 1 AS `Funcoes`,
 1 AS `Carga Horaria`,
 1 AS `Quantidade de servidores  Funcao/carga horaria`*/;
SET character_set_client = @saved_cs_client;

--
-- Temporary view structure for view `vi_funcaoxespecialidade`
--

DROP TABLE IF EXISTS `vi_funcaoxespecialidade`;
/*!50001 DROP VIEW IF EXISTS `vi_funcaoxespecialidade`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `vi_funcaoxespecialidade` AS SELECT 
 1 AS `Funcoes`,
 1 AS `Especialidade`,
 1 AS `Quantidade de servidores por Funcao/Especialidade`*/;
SET character_set_client = @saved_cs_client;

--
-- Temporary view structure for view `vi_funcaoxidade`
--

DROP TABLE IF EXISTS `vi_funcaoxidade`;
/*!50001 DROP VIEW IF EXISTS `vi_funcaoxidade`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `vi_funcaoxidade` AS SELECT 
 1 AS `Funcoes`,
 1 AS `Idade`,
 1 AS `Quantidade de servidores por Funcao/Idade`*/;
SET character_set_client = @saved_cs_client;

--
-- Temporary view structure for view `vi_maisdeumamatricula`
--

DROP TABLE IF EXISTS `vi_maisdeumamatricula`;
/*!50001 DROP VIEW IF EXISTS `vi_maisdeumamatricula`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `vi_maisdeumamatricula` AS SELECT 
 1 AS `Servidores com mais de uma matricula`*/;
SET character_set_client = @saved_cs_client;

--
-- Temporary view structure for view `vi_maxfor`
--

DROP TABLE IF EXISTS `vi_maxfor`;
/*!50001 DROP VIEW IF EXISTS `vi_maxfor`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `vi_maxfor` AS SELECT 
 1 AS `servidor`,
 1 AS `nivel`*/;
SET character_set_client = @saved_cs_client;

--
-- Temporary view structure for view `vi_naoconluidos`
--

DROP TABLE IF EXISTS `vi_naoconluidos`;
/*!50001 DROP VIEW IF EXISTS `vi_naoconluidos`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `vi_naoconluidos` AS SELECT 
 1 AS `Recadastramentos nao concluidos`*/;
SET character_set_client = @saved_cs_client;

--
-- Temporary view structure for view `vi_pessoascidadeatual`
--

DROP TABLE IF EXISTS `vi_pessoascidadeatual`;
/*!50001 DROP VIEW IF EXISTS `vi_pessoascidadeatual`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `vi_pessoascidadeatual` AS SELECT 
 1 AS `sigla`,
 1 AS `nome`,
 1 AS `Quantidade`*/;
SET character_set_client = @saved_cs_client;
...
--
-- Temporary view structure for view `vi_pessoascidadenatal`
--

DROP TABLE IF EXISTS `vi_pessoascidadenatal`;
/*!50001 DROP VIEW IF EXISTS `vi_pessoascidadenatal`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `vi_pessoascidadenatal` AS SELECT 
 1 AS `sigla`,
 1 AS `nome`,
 1 AS `Quantidade`*/;
SET character_set_client = @saved_cs_client;
...
--
-- Temporary view structure for view `vi_pessoasxquantidadedecursos`
--

DROP TABLE IF EXISTS `vi_pessoasxquantidadedecursos`;
/*!50001 DROP VIEW IF EXISTS `vi_pessoasxquantidadedecursos`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `vi_pessoasxquantidadedecursos` AS SELECT 
 1 AS `nome`,
 1 AS `Setores`,
 1 AS `descricao`,
 1 AS `Quantidade`*/;
...
--
-- Temporary view structure for view `vi_porcargahoraria`
--

DROP TABLE IF EXISTS `vi_porcargahoraria`;
/*!50001 DROP VIEW IF EXISTS `vi_porcargahoraria`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `vi_porcargahoraria` AS SELECT 
 1 AS `Carga horaria`,
 1 AS `Quantidade de servidores com essa carga horaria`*/;
SET character_set_client = @saved_cs_client;

--
-- Temporary view structure for view `vi_porespecialidade`
--

DROP TABLE IF EXISTS `vi_porespecialidade`;
/*!50001 DROP VIEW IF EXISTS `vi_porespecialidade`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `vi_porespecialidade` AS SELECT 
 1 AS `especialidade`,
 1 AS `Quantidade de servidores com essa especialidade`*/;
SET character_set_client = @saved_cs_client;

--
-- Temporary view structure for view `vi_porfuncao`
--

DROP TABLE IF EXISTS `vi_porfuncao`;
/*!50001 DROP VIEW IF EXISTS `vi_porfuncao`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `vi_porfuncao` AS SELECT 
 1 AS `Funcao`,
 1 AS `Quantidade`*/;
SET character_set_client = @saved_cs_client;

--
-- Temporary view structure for view `vi_poridade`
--

DROP TABLE IF EXISTS `vi_poridade`;
/*!50001 DROP VIEW IF EXISTS `vi_poridade`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `vi_poridade` AS SELECT 
 1 AS `Idade`,
 1 AS `Quantidade de servidores com a mesma idade`*/;
SET character_set_client = @saved_cs_client;

--
-- Temporary view structure for view `vi_porsetor`
--

DROP TABLE IF EXISTS `vi_porsetor`;
/*!50001 DROP VIEW IF EXISTS `vi_porsetor`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `vi_porsetor` AS SELECT 
 1 AS `Setores`,
 1 AS `Quantidade`*/;
SET character_set_client = @saved_cs_client;

--
-- Temporary view structure for view `vi_quantidadedependentes`
--

DROP TABLE IF EXISTS `vi_quantidadedependentes`;
/*!50001 DROP VIEW IF EXISTS `vi_quantidadedependentes`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `vi_quantidadedependentes` AS SELECT 
 1 AS `matricula`,
 1 AS `nome`,
 1 AS `Quantidade de dependentes`*/;
SET character_set_client = @saved_cs_client;

--
-- Temporary view structure for view `vi_setorxcargahoraria`
--

DROP TABLE IF EXISTS `vi_setorxcargahoraria`;
/*!50001 DROP VIEW IF EXISTS `vi_setorxcargahoraria`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `vi_setorxcargahoraria` AS SELECT 
 1 AS `Setores`,
 1 AS `Carga horaria`,
 1 AS `Quantidade de servidores com essa carga horaria`*/;
SET character_set_client = @saved_cs_client;
...
--
-- Temporary view structure for view `vi_setorxcedidos`
--

DROP TABLE IF EXISTS `vi_setorxcedidos`;
/*!50001 DROP VIEW IF EXISTS `vi_setorxcedidos`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `vi_setorxcedidos` AS SELECT 
 1 AS `Setores`,
 1 AS `Quantidade de funcionarios cedidos de uma secretaria para outra`*/;
SET character_set_client = @saved_cs_client;

--
-- Temporary view structure for view `vi_setorxespecialidade`
--

DROP TABLE IF EXISTS `vi_setorxespecialidade`;
/*!50001 DROP VIEW IF EXISTS `vi_setorxespecialidade`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `vi_setorxespecialidade` AS SELECT 
 1 AS `Setores`,
 1 AS `especialidade`,
 1 AS `Quantidade de servidores com essa especialidade`*/;
SET character_set_client = @saved_cs_client;
...
--
-- Temporary view structure for view `vi_setorxformacao`
--

DROP TABLE IF EXISTS `vi_setorxformacao`;
/*!50001 DROP VIEW IF EXISTS `vi_setorxformacao`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `vi_setorxformacao` AS SELECT 
 1 AS `Setores`,
 1 AS `descricao`,
 1 AS `Quantidade`*/;
SET character_set_client = @saved_cs_client;
...
--
-- Temporary view structure for view `vi_setorxfuncao`
--

DROP TABLE IF EXISTS `vi_setorxfuncao`;
/*!50001 DROP VIEW IF EXISTS `vi_setorxfuncao`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `vi_setorxfuncao` AS SELECT 
 1 AS `Setores`,
 1 AS `Funcao`,
 1 AS `Quantidade`*/;
SET character_set_client = @saved_cs_client;
...
--
-- Temporary view structure for view `vi_setorxidade`
--

DROP TABLE IF EXISTS `vi_setorxidade`;
/*!50001 DROP VIEW IF EXISTS `vi_setorxidade`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `vi_setorxidade` AS SELECT 
 1 AS `Setores`,
 1 AS `Idade`,
 1 AS `Quantidade de servidores com a mesma idade`*/;
SET character_set_client = @saved_cs_client;
...
--
-- Temporary view structure for view `vi_setorxlicenca`
--

DROP TABLE IF EXISTS `vi_setorxlicenca`;
/*!50001 DROP VIEW IF EXISTS `vi_setorxlicenca`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `vi_setorxlicenca` AS SELECT 
 1 AS `Setores`,
 1 AS `Quantidade de funcionarios de licença`*/;
SET character_set_client = @saved_cs_client;

--
-- Temporary view structure for view `vi_setorxmaisdeumamatricula`
--

DROP TABLE IF EXISTS `vi_setorxmaisdeumamatricula`;
/*!50001 DROP VIEW IF EXISTS `vi_setorxmaisdeumamatricula`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `vi_setorxmaisdeumamatricula` AS SELECT 
 1 AS `Setores`,
 1 AS `Servidores com mais de uma matricula`*/;
SET character_set_client = @saved_cs_client;

--
-- Temporary view structure for view `vi_setorxnaoconcluidos`
--

DROP TABLE IF EXISTS `vi_setorxnaoconcluidos`;
/*!50001 DROP VIEW IF EXISTS `vi_setorxnaoconcluidos`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `vi_setorxnaoconcluidos` AS SELECT 
 1 AS `Setores`,
 1 AS `Recadastramentos nao concluidos`*/;
SET character_set_client = @saved_cs_client;

--
-- Temporary view structure for view `vi_tempoaaverbar`
--

DROP TABLE IF EXISTS `vi_tempoaaverbar`;
/*!50001 DROP VIEW IF EXISTS `vi_tempoaaverbar`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `vi_tempoaaverbar` AS SELECT 
 1 AS `Servidores que tem tempo a averbar`*/;
SET character_set_client = @saved_cs_client;

--
-- Temporary view structure for view `vi_tempoaverbado`
--

DROP TABLE IF EXISTS `vi_tempoaverbado`;
/*!50001 DROP VIEW IF EXISTS `vi_tempoaverbado`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `vi_tempoaverbado` AS SELECT 
 1 AS `Servidores que tem tempo averbado`*/;
SET character_set_client = @saved_cs_client;

--
-- Temporary view structure for view `vi_totalgeral`
--

DROP TABLE IF EXISTS `vi_totalgeral`;
/*!50001 DROP VIEW IF EXISTS `vi_totalgeral`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `vi_totalgeral` AS SELECT 
 1 AS `Total de servidores`*/;
SET character_set_client = @saved_cs_client;

--
-- Final view structure for view `vi_cedidos`
--
...
/*!50001 VIEW `vi_cedidos` AS select count(`s`.`id`) AS `Quantidade de funcionarios cedidos de uma secretaria para outra` from (`servidores` `s` join `cedidos` `c` on((`s`.`id` = `c`.`Funcional_id`))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `vi_countnivel`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vi_countnivel` AS select `ne`.`descricao` AS `descricao`,count(`n`.`nivel`) AS `quant` from (`vi_maxfor` `n` join `nivelescolaridades` `ne` on((`ne`.`id` = `n`.`nivel`))) group by `n`.`nivel` order by `ne`.`id` desc */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `vi_dadosrelevantes`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vi_dadosrelevantes` AS select `s`.`nome` AS `nome`,if((char_length(`f`.`cargoinput`) > 0),`f`.`cargoinput`,convert(`c`.`descricao` using utf8)) AS `Cargo`,if((char_length(`f`.`funcaoinput`) > 0),`f`.`funcaoinput`,`fun`.`descricao`) AS `Funcao`,`ni`.`descricao` AS `Escolaridade`,concat((extract(year from curdate()) - extract(year from `s`.`datanasc`)),' anos') AS `Idade`,`s`.`necessidadesespeciais` AS `Necessidades especiais`,date_format(`f`.`admissao`,'%d/%m/%Y') AS `Data de Admissão` from (((((`servidores` `s` left join `funcionais` `f` on((`s`.`id` = `f`.`Servidor_id`))) left join `cargos` `c` on((`c`.`id` = `f`.`Cargo_id`))) left join `funcoes` `fun` on((`fun`.`id` = `f`.`Funcao_id`))) left join `formacoes` `fo` on((`fo`.`Servidor_id` = `s`.`id`))) left join `nivelescolaridades` `ni` on((`ni`.`id` = `fo`.`Nivelescolaridade_id`))) group by `s`.`nome` union select `s`.`nome` AS `nome`,if((char_length(`f`.`cargoinput`) > 0),`f`.`cargoinput`,convert(`c`.`descricao` using utf8)) AS `Cargo`,if((char_length(`f`.`funcaoinput`) > 0),`f`.`funcaoinput`,`fun`.`descricao`) AS `IF(char_length(f.funcaoinput) > 0,f.funcaoinput,fun.descricao)`,`ni`.`descricao` AS `Escolaridade`,concat((extract(year from curdate()) - extract(year from `s`.`datanasc`)),' anos') AS `Idade`,`s`.`necessidadesespeciais` AS `Necessidades especiais`,date_format(`f`.`admissao`,'%d/%m/%Y') AS `Data de Admissão` from (`nivelescolaridades` `ni` left join (`formacoes` `fo` left join (`funcoes` `fun` left join (`cargos` `c` left join (`funcionais` `f` left join `servidores` `s` on((`s`.`id` = `f`.`Servidor_id`))) on((`c`.`id` = `f`.`Cargo_id`))) on((`fun`.`id` = `f`.`Funcao_id`))) on((`fo`.`Servidor_id` = `s`.`id`))) on((`ni`.`id` = `fo`.`Nivelescolaridade_id`))) group by `s`.`nome` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `vi_delicenca`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vi_delicenca` AS select count(`s`.`id`) AS `Quantidade de servidores de licenca` from (`servidores` `s` join `funcionais` `fu`) where ((`s`.`id` = `fu`.`Servidor_id`) and (`fu`.`licenca` = 1)) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `vi_estadoscivis`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vi_estadoscivis` AS select `ec`.`descricao` AS `Descricao`,count(`s`.`id`) AS `Quantidade` from (`servidores` `s` join `estadocivis` `ec`) where (`s`.`Estadocivil_id` = `ec`.`id`) group by `ec`.`descricao` having (count(`ec`.`id`) >= 1) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `vi_funcaoxcargahoraria`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vi_funcaoxcargahoraria` AS select `fu`.`funcaoinput` AS `Funcoes`,`fu`.`cargahoraria` AS `Carga Horaria`,count(`fu`.`Servidor_id`) AS `Quantidade de servidores  Funcao/carga horaria` from `funcionais` `fu` where (char_length(`fu`.`funcaoinput`) <> 0) group by `fu`.`funcaoinput`,`fu`.`cargahoraria` union select `f`.`descricao` AS `Funcoes`,`fu`.`cargahoraria` AS `Carga Horaria`,count(`fu`.`Servidor_id`) AS `Quantidade de servidores  Funcao/carga horaria` from (`funcoes` `f` join `funcionais` `fu`) where (`fu`.`Funcao_id` = `f`.`id`) group by `f`.`descricao`,`fu`.`cargahoraria` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `vi_funcaoxespecialidade`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vi_funcaoxespecialidade` AS select `fu`.`funcaoinput` AS `Funcoes`,`s`.`especialidade` AS `Especialidade`,count(`fu`.`Servidor_id`) AS `Quantidade de servidores por Funcao/Especialidade` from (`funcionais` `fu` join `servidores` `s`) where ((char_length(`fu`.`funcaoinput`) <> 0) and (`fu`.`Servidor_id` = `s`.`id`)) group by `fu`.`funcaoinput`,`s`.`especialidade` union select `f`.`descricao` AS `Funcoes`,`s`.`especialidade` AS `Especialidade`,count(`fu`.`Servidor_id`) AS `Quantidade de servidores por Funcao/Especialidade` from ((`funcoes` `f` join `funcionais` `fu`) join `servidores` `s`) where ((`fu`.`Funcao_id` = `f`.`id`) and (`fu`.`Servidor_id` = `s`.`id`)) group by `fu`.`funcaoinput`,`s`.`especialidade` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `vi_funcaoxidade`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vi_funcaoxidade` AS select `fu`.`funcaoinput` AS `Funcoes`,(extract(year from curdate()) - extract(year from `s`.`datanasc`)) AS `Idade`,count(`fu`.`Servidor_id`) AS `Quantidade de servidores por Funcao/Idade` from (`funcionais` `fu` join `servidores` `s`) where ((char_length(`fu`.`funcaoinput`) <> 0) and (`fu`.`Servidor_id` = `s`.`id`)) group by `fu`.`funcaoinput`,(extract(year from curdate()) - extract(year from `s`.`datanasc`)) union select `f`.`descricao` AS `Funcoes`,(extract(year from curdate()) - extract(year from `s`.`datanasc`)) AS `Idade`,count(`fu`.`Servidor_id`) AS `Quantidade de servidores por Funcao/Idade` from ((`funcoes` `f` join `servidores` `s`) join `funcionais` `fu`) where ((`fu`.`Funcao_id` = `f`.`id`) and (`fu`.`Servidor_id` = `s`.`id`)) group by `fu`.`funcaoinput`,(extract(year from curdate()) - extract(year from `s`.`datanasc`)) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `vi_maisdeumamatricula`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vi_maisdeumamatricula` AS select count(`s`.`id`) AS `Servidores com mais de uma matricula` from `servidores` `s` where (`s`.`matricula2` <> 'NULL') */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `vi_maxfor`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vi_maxfor` AS select `f`.`Servidor_id` AS `servidor`,max(`f`.`Nivelescolaridade_id`) AS `nivel` from `formacoes` `f` group by `f`.`Servidor_id` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `vi_naoconluidos`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vi_naoconluidos` AS select count(`s`.`id`) AS `Recadastramentos nao concluidos` from `servidores` `s` where (`s`.`concluido` = 0) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `vi_pessoascidadeatual`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vi_pessoascidadeatual` AS select `es`.`sigla` AS `sigla`,`c`.`nome` AS `nome`,count(`s`.`id`) AS `Quantidade` from (((`servidores` `s` join `cidades` `c`) join `enderecos` `e`) join `estados` `es`) where ((`s`.`id` = `e`.`Servidor_id`) and (`e`.`Cidade_id` = `c`.`id`) and (`c`.`Estado_id` = `es`.`id`)) group by `c`.`nome` having (count(`s`.`id`) >= 1) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `vi_pessoascidadenatal`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vi_pessoascidadenatal` AS select `est`.`sigla` AS `sigla`,`ci`.`nome` AS `nome`,count(`ser`.`id`) AS `Quantidade` from ((`servidores` `ser` join `cidades` `ci`) join `estados` `est`) where ((`ser`.`Cidade_nasc` = `ci`.`id`) and (`ci`.`Estado_id` = `est`.`id`)) group by `ci`.`nome` having (count(`ser`.`id`) >= 1) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `vi_pessoasxquantidadedecursos`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vi_pessoasxquantidadedecursos` AS select `s`.`nome` AS `nome`,`se`.`descricao` AS `Setores`,`ni`.`descricao` AS `descricao`,count(`ni`.`id`) AS `Quantidade` from ((((`servidores` `s` join `funcionais` `f` on((`f`.`Servidor_id` = `s`.`id`))) join `setores` `se` on((`se`.`id` = `f`.`Setor_id`))) join `formacoes` `fo` on((`fo`.`Servidor_id` = `f`.`id`))) join `nivelescolaridades` `ni` on((`ni`.`id` = `fo`.`Nivelescolaridade_id`))) group by `s`.`nome`,`se`.`descricao`,`ni`.`descricao` having (`Quantidade` >= 0) union select `s`.`nome` AS `nome`,`f`.`setorinput` AS `Setores`,`ni`.`descricao` AS `descricao`,count(`ni`.`id`) AS `Quantidade` from (((`servidores` `s` join `funcionais` `f` on((`f`.`Servidor_id` = `s`.`id`))) join `formacoes` `fo` on((`fo`.`Servidor_id` = `s`.`id`))) join `nivelescolaridades` `ni` on((`fo`.`Nivelescolaridade_id` = `ni`.`id`))) group by `s`.`nome`,`f`.`setorinput`,`ni`.`descricao` having (`Quantidade` >= 0) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `vi_porcargahoraria`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vi_porcargahoraria` AS select `fu`.`cargahoraria` AS `Carga horaria`,count(`s`.`id`) AS `Quantidade de servidores com essa carga horaria` from (`servidores` `s` join `funcionais` `fu`) where (`s`.`id` = `fu`.`Servidor_id`) group by `fu`.`cargahoraria` having (count(`fu`.`cargahoraria`) >= 1) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `vi_porespecialidade`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vi_porespecialidade` AS select `s`.`especialidade` AS `especialidade`,count(`s`.`id`) AS `Quantidade de servidores com essa especialidade` from `servidores` `s` group by `s`.`especialidade` having (count(`s`.`especialidade`) >= 1) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `vi_porfuncao`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vi_porfuncao` AS select `fu`.`descricao` AS `Funcao`,count(`s`.`id`) AS `Quantidade` from ((`servidores` `s` join `funcionais` `f`) join `funcoes` `fu`) where ((`s`.`id` = `f`.`Servidor_id`) and (`f`.`Funcao_id` = `fu`.`id`)) group by `fu`.`descricao` having (count(`fu`.`descricao`) >= 1) union select `f`.`funcaoinput` AS `Funcao`,count(`s`.`id`) AS `Quantidade` from (`servidores` `s` join `funcionais` `f`) where (`s`.`id` = `f`.`Servidor_id`) group by `f`.`funcaoinput` having (count(`f`.`funcaoinput`) >= 1) order by `Funcao` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `vi_poridade`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vi_poridade` AS select concat((extract(year from curdate()) - extract(year from `s`.`datanasc`)),' anos') AS `Idade`,count(`s`.`id`) AS `Quantidade de servidores com a mesma idade` from `servidores` `s` group by concat((extract(year from curdate()) - extract(year from `s`.`datanasc`)),' anos') having (count(`s`.`id`) >= 0) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `vi_porsetor`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vi_porsetor` AS select `se`.`descricao` AS `Setores`,count(`s`.`id`) AS `Quantidade` from ((`servidores` `s` join `funcionais` `f`) join `setores` `se`) where ((`s`.`id` = `f`.`Servidor_id`) and (`f`.`Setor_id` = `se`.`id`)) group by `se`.`descricao` having (`Quantidade` > 1) union select `f`.`setorinput` AS `Setores`,count(`s`.`id`) AS `Quantidade` from (`servidores` `s` join `funcionais` `f`) where (`s`.`id` = `f`.`Servidor_id`) group by `f`.`setorinput` having (count(`f`.`setorinput`) >= 1) order by `Setores` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `vi_quantidadedependentes`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vi_quantidadedependentes` AS select `s`.`matricula` AS `matricula`,`s`.`nome` AS `nome`,count(`s`.`id`) AS `Quantidade de dependentes` from (`servidores` `s` join `dependentes` `d`) where (`s`.`id` = `d`.`servidor_id`) group by `s`.`nome` having (count(`s`.`id`) >= 1) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `vi_setorxcargahoraria`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vi_setorxcargahoraria` AS select `f`.`setorinput` AS `Setores`,`f`.`cargahoraria` AS `Carga horaria`,count(`s`.`id`) AS `Quantidade de servidores com essa carga horaria` from (`servidores` `s` join `funcionais` `f`) where ((`s`.`id` = `f`.`Servidor_id`) and (char_length(`f`.`setorinput`) <> 0)) group by `f`.`cargahoraria` having (count(`f`.`cargahoraria`) >= 1) union select `se`.`descricao` AS `Setores`,`f`.`cargahoraria` AS `Carga horaria`,count(`s`.`id`) AS `Quantidade de servidores com essa carga horaria` from ((`servidores` `s` join `funcionais` `f`) join `setores` `se`) where ((`s`.`id` = `f`.`Servidor_id`) and (`f`.`Setor_id` = `se`.`id`)) group by `f`.`cargahoraria` having (count(`f`.`cargahoraria`) >= 1) order by `Setores` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `vi_setorxcedidos`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vi_setorxcedidos` AS select `f`.`setorinput` AS `Setores`,count(`s`.`id`) AS `Quantidade de funcionarios cedidos de uma secretaria para outra` from ((`servidores` `s` join `cedidos` `c` on((`s`.`id` = `c`.`Funcional_id`))) join `funcionais` `f` on((`f`.`Servidor_id` = `s`.`id`))) where (`f`.`setorinput` <> (select (char_length(`f`.`setorinput`) <> 0))) group by `f`.`setorinput` having (count(`f`.`setorinput`) >= 0) union select `se`.`descricao` AS `Setores`,count(`s`.`id`) AS `Quantidade de funcionarios cedidos de uma secretaria para outra` from (((`servidores` `s` join `cedidos` `c` on((`s`.`id` = `c`.`Funcional_id`))) join `funcionais` `f` on((`f`.`Servidor_id` = `s`.`id`))) join `setores` `se` on((`f`.`Setor_id` = `se`.`id`))) group by `se`.`descricao` having (count(`se`.`descricao`) >= 0) order by `Setores` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `vi_setorxespecialidade`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vi_setorxespecialidade` AS select `se`.`descricao` AS `Setores`,`s`.`especialidade` AS `especialidade`,count(`s`.`id`) AS `Quantidade de servidores com essa especialidade` from ((`funcionais` `f` join `servidores` `s`) join `setores` `se`) where ((`s`.`id` = `f`.`Servidor_id`) and (`f`.`Setor_id` = `se`.`id`)) group by `s`.`especialidade` having (count(`s`.`especialidade`) >= 1) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `vi_setorxformacao`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vi_setorxformacao` AS select `se`.`descricao` AS `Setores`,`ni`.`descricao` AS `descricao`,count(`ni`.`id`) AS `Quantidade` from ((((`servidores` `s` join `funcionais` `f` on((`f`.`Servidor_id` = `s`.`id`))) join `setores` `se` on((`se`.`id` = `f`.`Setor_id`))) join `formacoes` `fo` on((`fo`.`Servidor_id` = `f`.`id`))) join `nivelescolaridades` `ni` on((`ni`.`id` = `fo`.`Nivelescolaridade_id`))) group by `se`.`descricao`,`ni`.`descricao` having (`Quantidade` >= 0) union select `f`.`setorinput` AS `Setores`,`ni`.`descricao` AS `descricao`,count(`s`.`id`) AS `Quantidade` from (((`servidores` `s` join `funcionais` `f` on((`f`.`Servidor_id` = `s`.`id`))) join `formacoes` `fo` on((`fo`.`Servidor_id` = `s`.`id`))) join `nivelescolaridades` `ni` on((`ni`.`id` = `fo`.`Nivelescolaridade_id`))) where (`f`.`setorinput` <> (select (char_length(`f`.`setorinput`) <> 0))) group by `f`.`setorinput`,`ni`.`descricao` having (count(`ni`.`descricao`) >= 0) order by `Setores` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `vi_setorxfuncao`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vi_setorxfuncao` AS select if((char_length(`f`.`setorinput`) > 0),`f`.`setorinput`,`se`.`descricao`) AS `Setores`,`fun`.`descricao` AS `Funcao`,count(`s`.`id`) AS `Quantidade` from (((`servidores` `s` join `funcionais` `f`) join `setores` `se`) join `funcoes` `fun`) where ((`s`.`id` = `f`.`Servidor_id`) and (`f`.`Setor_id` = `se`.`id`) and (`f`.`Funcao_id` = `fun`.`id`)) group by if((char_length(`f`.`setorinput`) > 0),`f`.`setorinput`,`se`.`descricao`),`fun`.`descricao` having (`Quantidade` > 1) union select if((char_length(`f`.`setorinput`) = 0),'------Educação-----',`f`.`setorinput`) AS `Setores`,`f`.`funcaoinput` AS `Funcao`,count(`s`.`id`) AS `Quantidade` from (`servidores` `s` join `funcionais` `f`) where ((`s`.`id` = `f`.`Servidor_id`) and (`f`.`setorinput` <> (select (char_length(`f`.`setorinput`) <> 0)))) group by if((char_length(`f`.`setorinput`) = 0),'------Educação-----',`f`.`setorinput`),`f`.`funcaoinput` having (count(`Setores`) >= 1) order by `Setores` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `vi_setorxidade`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vi_setorxidade` AS select `f`.`setorinput` AS `Setores`,concat((extract(year from curdate()) - extract(year from `s`.`datanasc`)),' anos') AS `Idade`,count(`s`.`id`) AS `Quantidade de servidores com a mesma idade` from (`servidores` `s` join `funcionais` `f`) where ((`s`.`id` = `f`.`Servidor_id`) and (char_length(`f`.`setorinput`) <> 0)) group by concat((extract(year from curdate()) - extract(year from `s`.`datanasc`)),' anos') having (count(`s`.`id`) >= 0) union select `se`.`descricao` AS `Setores`,concat((extract(year from curdate()) - extract(year from `s`.`datanasc`)),' anos') AS `Idade`,count(`s`.`id`) AS `Quantidade de servidores com a mesma idade` from ((`servidores` `s` join `funcionais` `f`) join `setores` `se`) where ((`s`.`id` = `f`.`Servidor_id`) and (`f`.`Setor_id` = `se`.`id`)) group by concat((extract(year from curdate()) - extract(year from `s`.`datanasc`)),' anos') having (count(`s`.`id`) >= 0) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `vi_setorxlicenca`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vi_setorxlicenca` AS select `f`.`setorinput` AS `Setores`,count(`s`.`id`) AS `Quantidade de funcionarios de licença` from (`servidores` `s` join `funcionais` `f` on((`f`.`Servidor_id` = `s`.`id`))) where ((char_length(`f`.`setorinput`) <> 0) and (`f`.`licenca` = 1)) group by `f`.`setorinput` having (count(`f`.`setorinput`) >= 0) union select `se`.`descricao` AS `Setores`,count(`s`.`id`) AS `Quantidade de funcionarios de licença` from ((`servidores` `s` join `funcionais` `f` on((`f`.`Servidor_id` = `s`.`id`))) join `setores` `se` on((`f`.`Setor_id` = `se`.`id`))) where (`f`.`licenca` = 1) group by `se`.`descricao` having (count(`se`.`descricao`) >= 0) order by `Setores` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `vi_setorxmaisdeumamatricula`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vi_setorxmaisdeumamatricula` AS select `f`.`setorinput` AS `Setores`,count(`s`.`id`) AS `Servidores com mais de uma matricula` from (`servidores` `s` join `funcionais` `f`) where ((`s`.`matricula2` <> 'NULL') and (`s`.`id` = `f`.`Servidor_id`) and (char_length(`f`.`setorinput`) <> 0)) group by `f`.`cargahoraria` having (count(`f`.`cargahoraria`) >= 1) union select `se`.`descricao` AS `Setores`,count(`s`.`id`) AS `Servidores com mais de uma matricula` from ((`servidores` `s` join `funcionais` `f`) join `setores` `se`) where ((`s`.`matricula2` <> 'NULL') and (`s`.`id` = `f`.`Servidor_id`) and (`f`.`Setor_id` = `se`.`id`)) group by `f`.`cargahoraria` having (count(`f`.`cargahoraria`) >= 1) order by `Setores` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `vi_setorxnaoconcluidos`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vi_setorxnaoconcluidos` AS select `f`.`setorinput` AS `Setores`,count(`s`.`id`) AS `Recadastramentos nao concluidos` from (`funcionais` `f` join `servidores` `s`) where ((`s`.`id` = `f`.`Servidor_id`) and (`s`.`concluido` = 0) and (char_length(`f`.`setorinput`) <> 0)) group by `f`.`setorinput` having (count(`s`.`id`) >= 0) union select `se`.`descricao` AS `Setores`,count(`s`.`id`) AS `Recadastramentos nao concluidos` from ((`funcionais` `f` join `servidores` `s`) join `setores` `se`) where ((`s`.`id` = `f`.`Servidor_id`) and (`f`.`Setor_id` = `se`.`id`) and (`s`.`concluido` = 0)) group by `se`.`descricao` having (count(`s`.`id`) >= 0) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `vi_tempoaaverbar`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vi_tempoaaverbar` AS select count(`s`.`id`) AS `Servidores que tem tempo a averbar` from `servidores` `s` where (`s`.`tempoaaverbar` = 1) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `vi_tempoaverbado`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vi_tempoaverbado` AS select count(`s`.`id`) AS `Servidores que tem tempo averbado` from `servidores` `s` where (`s`.`tempoaverbado` = 1) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `vi_totalgeral`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vi_totalgeral` AS select count(0) AS `Total de servidores` from `servidores` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2017-11-25  8:27:02
