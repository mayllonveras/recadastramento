...
<?php echo $this->Form->create('Funcional');?>
	<fieldset>
		<legend><?php __('Admin Edit Funcional'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('Funcional.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('Funcional.id'))); ?></li>
