...
<div class="funcionais form">
    ...
    <fieldset>
        ...
        echo '</div>';
        echo '<div class="grid-6-12 left">';
        echo $this->Form->input('setorinput', array('label' => 'Setor'));
        echo $this->Form->input('Setor_id', array('type' => 'hidden', 'value' => '9999'));
        echo '</div>';
        echo '<div class="grid-6-12 left">';
        echo $this->Form->input('cargoinput', array('label' => 'Cargo'));
        echo $this->Form->input('Cargo_id', array('type' => 'hidden', 'value' => '9999'));
        echo '</div>';
        echo '<div class="grid-6-12 left">';
        echo $this->Form->input('funcaoinput', array('label' => 'Função'));
        echo $this->Form->input('Funcao_id', array('label' => 'Função', 'type' => 'hidden', 'value' => '9999'));
        echo '</div>';
