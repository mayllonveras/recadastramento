<script type="text/javascript">
    ...
    function outrafuncao(op) {
        if(op == 999 ){
            document.getElementById("campooutrafuncao").style.display = "block";
        }else{
            document.getElementById("campooutrafuncao").style.display = "none";
        }
    }
</script>
<div class="funcionais form">
    ...
    <fieldset>
        ...
        echo $this->Form->input('admissao', array('label' => 'Data de admissão', 'dateFormat' => 'DMY', 'minYear' => date('Y')-80, 'maxYear'=>date('Y'), 'class' => 'data'));
        echo '</div>';
        echo '<div class="grid-6-12 left">';
        echo $this->Form->input('efetivoexercicio', array('label' => 'Data de inicio das atividades', 'minYear' => date('Y')-80, 'maxYear'=>date('Y'), 'dateFormat' => 'DMY', 'class' => 'data'));
        echo '</div>';
        ...
        echo '</div>';
        echo '<div class="grid-6-12 left">';
        echo $this->Form->input('Funcao_id', array('label' => 'Função', 'onchange'=>'outrafuncao(this.value)', 'empty' => 'Selecione'));
        echo '</div>';
        echo '<div id="campooutrafuncao" style="display:none">';
        echo '<div class="grid-4-12 left">';
        echo $this->Form->input('outrafuncao', array('label' => 'Outra Função'));
        echo '</div>';
        echo '</div>';
        ...
        echo '</div>';
        echo '<div class="grid-6-12 left">';
        echo $this->Form->input('vencimentolicenca', array('label' => 'Data de vencimento da licença', 'dateFormat' => 'DMY', 'minYear' => date('Y'), 'class' => 'data', 'value'=>''));
        echo '</div>';
        echo '</div>';
        ...
        echo '<div class="grid-6-12 left">';
        echo $this->Form->input('datareintegracao', array('label' => 'Data de reintegração', 'minYear' => date('Y')-80, 'maxYear'=>date('Y'), 'dateFormat' => 'DMY', 'class' => 'data'));
        echo '</div>';
        echo '</div>';
        echo '<div class="grid-3-12 left">';
