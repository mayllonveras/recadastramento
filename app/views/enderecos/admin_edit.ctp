...
<?php echo $this->Form->create('Endereco');?>
	<fieldset>
		<legend><?php __('Admin Edit Endereco'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('Endereco.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('Endereco.id'))); ?></li>
