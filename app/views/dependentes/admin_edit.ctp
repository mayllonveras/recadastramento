...
<?php echo $this->Form->create('Dependente');?>
	<fieldset>
		<legend><?php __('Admin Edit Dependente'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('Dependente.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('Dependente.id'))); ?></li>
