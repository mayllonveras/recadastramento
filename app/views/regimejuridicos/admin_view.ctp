<div class="regimejuridicos view">
<h2><?php  __('Regimejuridico');?></h2>
	<dl><?php $i = 0; $class = ' class="altrow"';?>
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php __('Id'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $regimejuridico['Regimejuridico']['id']; ?>
			&nbsp;
		</dd>
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php __('Descricao'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $regimejuridico['Regimejuridico']['descricao']; ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Regimejuridico', true), array('action' => 'edit', $regimejuridico['Regimejuridico']['id'])); ?> </li>
		<li><?php echo $this->Html->link(__('Delete Regimejuridico', true), array('action' => 'delete', $regimejuridico['Regimejuridico']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $regimejuridico['Regimejuridico']['id'])); ?> </li>
...
<div class="related">
	...
	<?php if (!empty($regimejuridico['Funcional'])):?>
	...
	<?php
		$i = 0;
		foreach ($regimejuridico['Funcional'] as $funcional):
			$class = null;
			if ($i++ % 2 == 0) {
				$class = ' class="altrow"';
			}
