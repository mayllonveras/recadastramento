...
<?php echo $this->Form->create('Formacao');?>
	<fieldset>
		<legend><?php __('Admin Edit Formacao'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('Formacao.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('Formacao.id'))); ?></li>
