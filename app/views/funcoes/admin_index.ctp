<div class="funcoes index">
	...
	<tr<?php echo $class;?>>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('View', true), array('action' => 'view', $funcao['Funcao']['id'])); ?>
			<?php echo $this->Html->link(__('Edit', true), array('action' => 'edit', $funcao['Funcao']['id'])); ?>
			<?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $funcao['Funcao']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $funcao['Funcao']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
